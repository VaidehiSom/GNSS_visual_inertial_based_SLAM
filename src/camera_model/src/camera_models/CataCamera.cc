...
CataCamera::Parameters::Parameters()
 ...
 , m_xi(0.0) // mirror param
 , m_k1(0.0) // raidal distortion
 , m_k2(0.0) // raidal distortion
 , m_p1(0.0) // decentering distortion
 , m_p2(0.0) // decentering distortion
 , m_gamma1(0.0) // focal length
 , m_gamma2(0.0) // focal length
 , m_u0(0.0) // principal point
 , m_v0(0.0) // principal point
{
