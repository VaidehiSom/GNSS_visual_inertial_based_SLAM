...
struct GnssMeasMsg_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::gnss_comm::GnssObsMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::gnss_comm::GnssObsMsg_<ContainerAllocator> >> _meas_type;
  _meas_type meas;
